      ...
      if (timeLeft <= 0) {
        ...
        setTimeout(() => {
          if (winnerIndex === selectedWinners.length - 1) {
            ...
            // More winners to reveal - wait for manual input
            setPhase('waiting');
          }
        }, 3000);
      }
      ...
      <div className="text-center w-full max-w-4xl">
        ...
        {phase === 'waiting' && currentWinner && (
          <div>
            ...
            <div className="bg-white/20 backdrop-blur-xl rounded-3xl p-8 md:p-12 border border-white/30 shadow-2xl min-h-[400px] flex items-center justify-center">
              <div className="text-center">
                <div className="bg-white/30 backdrop-blur-sm rounded-2xl p-8 border border-white/40 shadow-lg mb-8">
                  <div className="text-4xl md:text-5xl font-bold text-white mb-4">
                    {currentWinner.name}
                  </div>
                  <div className="text-2xl text-white font-semibold mb-3">
                ...
                <motion.button
                  ...
                  className="px-8 py-4 bg-gradient-to-r from-green-500 to-blue-500 text-white rounded-full font-bold text-xl hover:from-green-600 hover:to-blue-600 focus:ring-4 focus:ring-green-500/50 transition-all duration-300 shadow-lg"
                >
                  🎯 Draw Next Winner ({currentWinnerIndex + 2}/{winnerCount})
                </motion.button>
              </div>
            </div>
          </div>
        ...
        >
          ...
          {phase === 'waiting' && '🎯 Ready for the next draw? 🎯'}
